...
galaxy:
	...
	go build \
	    -ldflags "-s -w -X github.com/deamchain/go-galaxy/cmd/galaxy/launcher.gitCommit=$${GIT_COMMIT} -X github.com/deamchain/go-galaxy/cmd/galaxy/launcher.gitDate=$${GIT_DATE}" \
	    -o build/galaxy \
	    ./cmd/galaxy
