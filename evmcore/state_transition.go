...
func (st *StateTransition) buyGas() error {
	...
	// Note: Galaxy doesn't need to check against gasFeeCap instead of gasPrice, as it's too aggressive in the asynchronous environment
...
func (st *StateTransition) preCheck() error {
	...
	// Note: Galaxy doesn't need to check gasFeeCap >= BaseFee, because it's already checked by epochcheck
	return st.buyGas()
}
