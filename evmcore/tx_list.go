...
// Filter, as opposed to 'filter', re-initialises the heap after the galaxytion is done.
...
// txPricedList is a price-sorted heap to allow galaxyting on transactions pool
