...
func (m *GalaxyEpochsSealerModule) Start(block iblockproc.BlockCtx, bs iblockproc.BlockState, es iblockproc.EpochState) blockproc.SealerProcessor {
...
func (p *GalaxyEpochsSealer) Update(bs iblockproc.BlockState, es iblockproc.EpochState) {
	p.bs, p.es = bs, es
}

// SealEpoch is called after pre-internal transactions are executed
func (s *GalaxyEpochsSealer) SealEpoch() (iblockproc.BlockState, iblockproc.EpochState) {
