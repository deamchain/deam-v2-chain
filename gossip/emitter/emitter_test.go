...
//go:generate go run github.com/golang/mock/mockgen -package=mock -destination=mock/world.go go-galaxy/gossip/emitter External,TxPool,TxSigner,Signer
