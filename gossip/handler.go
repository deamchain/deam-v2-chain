...
import (
	...
	"github.com/deamchain/deam-v2-base/gossip/dagprocessor"
	"github.com/deamchain/deam-v2-base/gossip/itemsfetcher"
	...
	"github.com/deamchain/deam-v2-base/utils/datasemaphore"
	...
	"go-galaxy/eventcheck/bvallcheck"
	"go-galaxy/eventcheck/epochcheck"
	"go-galaxy/eventcheck/evallcheck"
	"go-galaxy/eventcheck/heavycheck"
	"go-galaxy/eventcheck/parentlesscheck"
	"go-galaxy/evmcore"
	"go-galaxy/gossip/protocols/blockrecords/brprocessor"
	"go-galaxy/gossip/protocols/blockrecords/brstream"
	"go-galaxy/gossip/protocols/blockrecords/brstream/brstreamleecher"
	"go-galaxy/gossip/protocols/blockrecords/brstream/brstreamseeder"
	"go-galaxy/gossip/protocols/blockvotes/bvprocessor"
	"go-galaxy/gossip/protocols/blockvotes/bvstream"
	"go-galaxy/gossip/protocols/blockvotes/bvstream/bvstreamleecher"
	"go-galaxy/gossip/protocols/blockvotes/bvstream/bvstreamseeder"
	"go-galaxy/gossip/protocols/dag/dagstream"
	"go-galaxy/gossip/protocols/dag/dagstream/dagstreamleecher"
	"go-galaxy/gossip/protocols/dag/dagstream/dagstreamseeder"
	"go-galaxy/gossip/protocols/epochpacks/epprocessor"
	"go-galaxy/gossip/protocols/epochpacks/epstream"
	"go-galaxy/gossip/protocols/epochpacks/epstream/epstreamleecher"
	"go-galaxy/gossip/protocols/epochpacks/epstream/epstreamseeder"
	"go-galaxy/gossip/protocols/snap/snapstream/snapleecher"
	"go-galaxy/inter"
	"go-galaxy/inter/ibr"
	"go-galaxy/inter/ier"
	"go-galaxy/logger"
...
// newHandler returns a new chain sub protocol manager. The chain sub protocol manages peers capable
// with the chain network.
func newHandler(
	c handlerConfig,
) (
	*handler,
...
func (h *handler) Stop() {
	log.Info("Stopping Galaxy protocol")
	...
	log.Info("Galaxy protocol stopped")
}
...
func (h *handler) handle(p *peer) error {
	...
	if p.RunningCap(ProtocolName, []uint{V63}) {
