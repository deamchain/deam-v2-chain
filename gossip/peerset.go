...
var (
	...
	// errSnapWithoutGalaxy is returned if a peer attempts to connect only on the
	// snap protocol without advertizing the galaxy main protocol.
	errSnapWithoutGalaxy = errors.New("peer connected on snap without compatible galaxy support")
)
